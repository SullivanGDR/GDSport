...
class HommeController extends AbstractController
{
    ...
    {
        $hommeGenre = $this->getDoctrine()->getRepository(Genre::class)->findBy(['libelle' => 'Homme']);
        $articlesHomme = $this->getDoctrine()->getRepository(Article::class)->findBy(['genre' => $hommeGenre]);
