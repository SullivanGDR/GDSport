...
class JuniorController extends AbstractController
{
    ...
    public function index(Request $request, EntityManagerInterface $entityManagerInterface): Response
    {
        ...
        $juniorGenre = $this->getDoctrine()->getRepository(Genre::class)->findBy(['libelle' => 'Junior']);
        $articlesJunior = $this->getDoctrine()->getRepository(Article::class)->findBy(['genre' => $juniorGenre]);
